...
:-ms-input-placeholder {
  color: #888;
	...
	<title>
		Send email via Gmail API using PHP
	</title>
...
<div class="container">  
  <form id="contact" action="send.php" method="POST">
    ...
    <h4><meta name="description" content="Send email via Gmail API using PHP."></h4>
    <fieldset>
  ...
  <?php else : // if user is not logged in, show sign in link ?>
	...
	<p class="copyright">Designed by <a href="<?php echo $login_url; ?>"><h3>Sign in with Gmail</h3></a></p>
	<?php endif; ?>
</div>
</body>
</html>